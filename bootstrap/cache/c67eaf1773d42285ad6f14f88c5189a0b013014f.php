                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="50" class="text-right">
                                ...
                                <div class="reveal" id="item-subcategory-<?php echo e($subcategory['id']); ?>" data-reveal data-close-on-click="false" data-close-on-esc="false"
                                    data-animation-in="scale-in-up">
                                    <div class="notification callout primary"></div>
                                    ...
                                    <form>
                                        <div class="input-group">
                                            ...
                                            <div>
                                                <input type="submit" class="button update-subcategory" id="<?php echo e($subcategory['id']); ?>" data-category_id="<?php echo e($subcategory['category_id']); ?>"
